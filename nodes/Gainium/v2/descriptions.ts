...
export const v2Properties: INodeProperties[] = [
  {
    displayName:
      "Calls Gainium API v2. Refer to the official API documentation for request/response details.",
    name: "noticeV2",
    type: "notice",
    default: "",
  },
  ...
  // --- Update ---
  {
    ...
    default: "{\n  \"tpPerc\": \"2\",\n  \"useTp\": true\n}",
    description:
      "JSON object with only the fields you want to change. Refer to the Gainium API docs.",
    displayOptions: {
      show: { resource: ["bots"], operation: ["update"] },
    },
  },
  ...
  },
  {
    ...
    default: "{}",
    description:
      "Optional filter, e.g. {\"items\":[{\"field\":\"marketCap\",\"operator\":\">\",\"value\":\"1000000\"}],\"linkOperator\":\"and\"}. Leave as {} for no filter.",
    displayOptions: {
      show: { resource: ["general"], operation: ["screener"] },
    },
  },
